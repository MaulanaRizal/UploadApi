...
<head>
	...
	<meta charset="utf-8" />
	<title>API UPLOAD - Upload file</title>
						...
						<ul class="dropdown-menu-right dropdown-navbar dropdown-menu dropdown-caret dropdown-close">
							...
							<li class="dropdown-content">
								<ul class="dropdown-menu dropdown-navbar">
									...
									<li>
										<a href="#" class="clearfix">
											<img src="<?php echo base_url();?>assets/images/avatars/avatar3.png"
									...
									<li>
										<a href="#" class="clearfix">
											<img src="<?php echo base_url();?>assets/images/avatars/avatar5.png"
	...
	<div class="container">
		...
		<div class="col-4">
			<div class="widget-box">
				...
				<?php echo form_open_multipart('upload/prosesUpload'); ?>
				<!-- <form action="<?php echo base_url()?>index.php/upload/check" enctype="multipart/form-data" method="post" accept-charset="utf-8"> -->
				<!-- <form action="<?php //echo base_url()?>index.php/upload/prosesUpload" method="post"> -->
				<div class="widget-body">
					<div class="widget-main">
						...
						<div class="form-group">
							<div class="col-xs-12">
								<input multiple="" type="file" name="gambar[]" id="id-input-file-3" />
						...
						<label>
                            ...
                            <span class="lbl"> Upload Filemu disini</span> -->
							<div class=col-xs-12>
							</div>
						</label>
					</div>
						...
						<div class=row>
							<div col=col-xs-12>
								<ul class="ace-thumbnails clearfix">
									<?php foreach ($query as $gambar){?>
									<li>
									<a href="<?php echo base_url();?>assets/upload/<?php echo $gambar->judul; ?>"
											title="Photo Title" data-rel="colorbox">
											<img height="150" alt="150x150"
												src="<?php echo base_url();?>assets/upload/<?php echo $gambar->judul; ?>" />
										</a>
